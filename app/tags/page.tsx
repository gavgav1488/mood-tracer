...
import { Tag, Plus, Pencil, Trash2, Save, X, Loader2, Home, ArrowLeft } from 'lucide-react';
...
export default function TagsPage() {
  ...
  return (
    <div className="container py-10">
      <div className="mb-6">
        <Link href="/" className="inline-flex items-center gap-2 text-purple-500 hover:text-purple-600 mb-2">
